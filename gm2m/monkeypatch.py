...
def _alter_many_to_many(self, model, old_field, new_field, strict):
    ...
    if isinstance(old_field, GM2MField) or isinstance(new_field, GM2MField):
        ...
        return _alter_many_to_many_0(self, model, old_field, new_field, strict)
...
def _alter_many_to_many(self, model, old_field, new_field, strict):
    ...
    if isinstance(old_field, GM2MField) or isinstance(new_field, GM2MField):
        ...
        return _alter_many_to_many_sqlite0(self, model, old_field, new_field, strict)
...
MigrationAutodetector.only_relation_agnostic_fields = only_relation_agnostic_fields
...
def database_forwards(self, app_label, schema_editor, from_state, to_state):
    ...
    old_model._meta.related_objects = [
        o for o in related_objects_bck if not o.auto_created
    ]
